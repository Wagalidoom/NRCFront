...
import { ClaimValidatorStyleWrapper } from "./ClaimValidator.style";
...
export const ClaimValidator = () => {
  const { claim, state, setState, selectId, setIsClaimOpen, claimLoading } =
    useEthereum();
    ...
    <ClaimValidatorStyleWrapper>
      <div className="callContractContainer">
        <div className="mintContent" ref={componentRef}>
          ...
          >
            Claim : {state === "success" ? <></> : "Number Runner #"} {selectId}
