...
export const MyNftContainer = styled.div`
  ...
  .button {
    ...
    border-radius: 5px;
    border: 1px solid
      ${(props) => (props.theme.name === "Light Theme" ? "#afafaf" : "#afafaf")};
    margin-right: 10px;
  }
  .filter,
  .sweep {
  ...
  .filter-select {
    ...
    color: ${(props) => props.theme.colors.text};
    background: ${(props) =>
      props.theme.name === "Dark Theme" ? "rgb(30,39,50)" : "rgb(239,243,244)"};
  }
  .visible {
    border: 1px solid
      ${(props) => (props.theme.name === "Light Theme" ? "#afafaf" : "#afafaf")};
  ...
  .filter-option {
    ...
    background: ${(props) =>
      !props.isFilterApplied && props.theme.name === "Dark Theme"
        ? "rgb(30,39,50)"
        : "rgb(239,243,244)"};
  ...
  .myNft {
    ...
    box-shadow: ${(props) =>
      props.theme.name === "Dark Theme"
        ? "rgb(0, 0, 0) 0px 2px 4px, rgb(0, 0, 0) 0px 7px 13px -3px, rgb(0, 0, 0) 0px -3px 0px"
        : "rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px"};
  }
  .myNft > img {
    width: 100%;
    border-top-left-radius: 10px;
...
export const ToolBar = styled.div`
  ...
  .modal-button {
    ...
    border: 1px solid
      ${(props) =>
        props.theme.name === "Dark Theme" ? "grey" : "rgba(0,0,0,0.6)"};
    width: 30px;
    height: 12px;
  ...
  .modal-option > ul > hr {
    ...
    left: 0px;
    color: ${(props) =>
      props.theme.name === "Dark Theme" ? "rgb(247,249,249)" : "rgb(48,60,67)"};
  }
  .option {
    height: 26px;
    font-weight: 700;
