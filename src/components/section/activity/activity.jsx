...
export const Activity = (props) => {
    ...
    return (
        <ActivityContainer filter={props.container === 'right' ? true :false}>
            <div className="filter-section">
                <div className="filter-container" >
                    {arrayFilters.map((element, index) =>
                        <ButtonFilter active={element === filter ? true: false} className="filter " key={index} onClick={() => changeFilter(element)} >{element}</ButtonFilter>
                    )}
                </div>
            </div>
            {filter === 'sales' &&
            <div className="activity" >
                <div className="activity-left">
                    <div className="activity-info">
                        <span>
                            <span style={{color:'#ADD8E6'}}>Offer<br></br>Accepted</span>                        
                        </span>
                    </div>
                    <p>2 hours ago</p>
                ...
                <div className="activity-right">
                  <div className="activity-card">
                    ...
                    <div className="activity-infos-right">
                        ...
                        <p>Pow { filter !== 'burn' && <span style={{position:'absolute',right:'8px'}}><img className="eth-logo" src={ethBlue} alt="" />
                        <span style={{color:'#ADD8E6'}}>1.06</span></span>} </p>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div className="activity" key={index}>
                ...
                <div className="activity-left">
                    <div className="activity-info">
                        <span>
                            ...
                            {filter === 'accepted' && <span style={{color:'#ADD8E6'}}>Offer<br></br>Accepted</span>}                            
                        </span>
                    </div>
                    <p>2 hours ago</p>
                    <div className="activity-user">
                ...
                <div className="activity-right">
                  <div className="activity-card">
                    ...
                    <div className="activity-infos-right">
                        <p>Number Runner #2236</p>
                        <p>Pow { filter !== 'burn' && <span style={{position:'absolute',right:'8px'}}><img  className="eth-logo" src={filter === 'sales' ? ethGreen : ethBlue} alt="" />
                        <span style={{color:filter === 'sales' ? '#B3E6B5': '#ADD8E6'}}>1.06</span></span>} </p>
                    </div>
                    </div>
                </div>
                </div>
            ...
            {props.container !== 'right' &&<div className="activity-show" >
                        Show more
            </div> }
