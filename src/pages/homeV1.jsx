                      ...
                      {(listLang === "EN" ||
                        ...
                        <div className="description">
                          ...
                          <i>
                            ...
                            0.01 eth will be used to activate the function. The
                            pot of one of the king's burn hands
                            "unintentionally" is redistributed to the prize
                            pool.
                          </i>
                          <div className="contentBanner">
                            <img src={mainRoi} alt="" />
                      ...
                      {(listLang === "FR" ||
                        ...
                        <div className="description">
                          ...
                          <i>
                            ...
                            avant que ce soit sold out. 0.01 eth sera utilisé
                            pour activer la fonction. La cagnotte d’une main du
                            roi burn « sans faire exprès » est redistribuée à la
                            cagnotte générale.
                          </i>
                          <div className="contentBanner">
                            <img src={mainRoi} alt="" />
                      ...
                      {(listLang === "ES" ||
                        ...
                        <div className="description">
                          ...
                          <i>
                            ...
                            El 0.01 eth se utilizará para activar la función. El
                            premio de una mano del rey quemado “sin intención”
                            se redistribuye al premio final.
                          </i>
                          <div className="contentBanner">
                            <img src={mainRoi} alt="" />
                          </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      {(listLang === "ES" ||
                        ...
                        <div className="description">
                          <i style={{ fontSize: "14px" }}>
                            « El cazador más sabio. Rápido, preciso. »
                          </i>
                          <br />
                          <br />
